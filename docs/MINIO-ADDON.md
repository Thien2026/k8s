...
| Lớp | Ý nghĩa |
|-----|---------|
| **Storage GB** | PVC + `mc admin bucket quota --hard` ≈ tổng data bucket |
...
**Phase 2 (sau):** tách app key khỏi root + allowlist đuôi file trên IAM — chặn cứng hơn trên đường S3 trực tiếp.
